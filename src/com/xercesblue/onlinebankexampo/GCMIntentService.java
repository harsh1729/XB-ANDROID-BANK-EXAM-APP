...
public class GCMIntentService extends GCMBaseIntentService {
	...
	public static final String SENDER_ID = "960465423997";
	...
	protected void onMessage(Context context, Intent data) {
		try {
			...
			String heading = "Bank PO / Clerical";
			...
			if (android.os.Build.VERSION.SDK_INT < 11) {
				NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(
						...
						.setContentTitle(heading).setContentText(pushMessage);
			...
			if (android.os.Build.VERSION.SDK_INT < android.os.Build.VERSION_CODES.JELLY_BEAN) {
				...
				.setContentText(pushMessage).setContentIntent(pIntent)
				// .setContentInfo(
				// String.valueOf(++MainActivity.numOfNotifications) )
