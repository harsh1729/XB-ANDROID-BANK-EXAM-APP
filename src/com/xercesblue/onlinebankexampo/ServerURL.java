...
public class ServerURL {
	...
	public static String getDownload_question_link(long qusNumber ,String deviceImei, String langCode,Context con ) {
		return "http://www.xercesblue.in/onlinexamserver/liquid_data/xport_xml.php?lastQuestionNumber="+qusNumber+"&appId="+Globals.APP_ID+"&deviceIMEI="+deviceImei+"&LangCode="+langCode+"&gcmId="+Globals.GCM_REG_ID+"&version_code="+Globals.getversion_code(con);
	}
